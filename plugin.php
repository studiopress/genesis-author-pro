...
function osom_author_pro_block_type_variations( $variations, $block_type ) {
	...
	if ( 'core/paragraph' === $block_type->name ) {
		$variations[] = array(
			...
			'icon'       => 'book-alt',
			'category'   => 'author-pro',
			'keywords'   => array( 'book', 'author pro', 'featured' ),
			'attributes' => array(
				'metadata' => array(
					'bindings' => array(
						'content' => array(
	...
	if ( 'core/paragraph' === $block_type->name ) {
		$variations[] = array(
			...
			'keywords'   => array( 'book', 'author pro', 'price' ),
		);
	}
	...
	if ( 'core/paragraph' === $block_type->name ) {
		$variations[] = array(
			...
			'icon'       => 'book-alt',
			'category'   => 'author-pro',
			'keywords'   => array( 'book', 'author pro', 'isbn' ),
			'attributes' => array(
				'metadata' => array(
					'bindings' => array(
						'content' => array(
	...
	if ( 'core/paragraph' === $block_type->name ) {
		$variations[] = array(
			...
			'icon'       => 'building',
			'category'   => 'author-pro',
			'keywords'   => array( 'book', 'author pro', 'publisher' ),
			'attributes' => array(
				'metadata' => array(
					'bindings' => array(
						'content' => array(
	...
	if ( 'core/paragraph' === $block_type->name ) {
		$variations[] = array(
			...
			'icon'       => 'edit',
			'category'   => 'author-pro',
			'keywords'   => array( 'book', 'author pro', 'editor' ),
			'attributes' => array(
				'metadata' => array(
					'bindings' => array(
						'content' => array(
	...
	if ( 'core/paragraph' === $block_type->name ) {
		$variations[] = array(
			...
			'icon'       => 'book',
			'category'   => 'author-pro',
			'keywords'   => array( 'book', 'author pro', 'edition' ),
			'attributes' => array(
				'metadata' => array(
					'bindings' => array(
						'content' => array(
	...
	if ( 'core/paragraph' === $block_type->name ) {
		$variations[] = array(
			...
			'icon'       => 'calendar-alt',
			'category'   => 'author-pro',
			'keywords'   => array( 'book', 'author pro', 'publication date', 'date' ),
			'attributes' => array(
				'metadata' => array(
					'bindings' => array(
						'content' => array(
	...
	if ( 'core/paragraph' === $block_type->name ) {
		$variations[] = array(
			...
			'category'   => 'author-pro',
			'keywords'   => array( 'book', 'author pro', 'available'),
			'attributes' => array(
				'metadata' => array(
					'bindings' => array(
						'content' => array(
